...
using Npgsql;
using NpgsqlTypes;
using Theradex.ODS.DataAccess.Helpers;
using Theradex.ODS.DataAccess.Interfaces;
using Theradex.ODS.DataAccess.Models;
using Theradex.ODS.DataAccess.Repositories;
using System;
...
namespace Theradex.ODS.DataAccess.Repositories
{
    public class BatchRunControlRepository : IBatchRunControlRepository<BatchRunControl>
    {
        private readonly IConfigurationRoot _config;
        private readonly ILogger<BatchRunControlRepository> _logger;
        ...
        public BatchRunControlRepository(ILogger<BatchRunControlRepository> logger, IConfigurationRoot config)
        {
            _config = config;
            _logger = logger;
            CONNECTION_STRING = _config.GetValue("AppSettings:DatabaseConnectingString", defalutConnectionString);
        }
