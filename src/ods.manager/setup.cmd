...
aws --endpoint-url=http://localhost:4566 --profile LocalStack ssm put-parameter --name "/local-stack/app/odsextractor/ODSSettings/Host" --type String --value "ods.cluster-cgntten8b01g.us-west-1.rds.amazonaws.com" --overwrite
...
aws --endpoint-url=http://localhost:4566 --profile LocalStack ssm put-parameter --name "/local-stack/app/odsmanager/ODSSettings/Host" --type String --value "ods.cluster-cgntten8b01g.us-west-1.rds.amazonaws.com" --overwrite
